...
echo "7.  nc1_start  = start: number of candidates of 1st filtering (ppm)"
echo "8.  nc1_end    = end "
echo "9.  nc1_step   = step"
echo "10. nc2_start  = start: number of candidates of 2nd filtering (ppm)"
echo "11. nc2_end    = end"
echo "12. nc2_step   = step"
echo "13. num_k      = k (number of neighbors)"
echo "14. num_q      = number of queries (0 -> all)"
echo "15. p_1st      = p of score * 10 for 1st filtering"
echo "16. p_2nd      = p of score * 10 for 2nd filtering"
